...
function describe_city(city, country) {
    ...
    return "The ".concat(city, " city is in ").concat(country);
}
var myfun = describe_city("Karachi", "Pakistan");
var myfun2 = describe_city("Tokyo", "Japan");
var myfun3 = describe_city("Alaska");
console.log(myfun);
console.log(myfun2);
console.log(myfun3);
